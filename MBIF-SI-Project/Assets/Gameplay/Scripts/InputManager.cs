// File: Scripts/InputManager.cs (Versi PC & Mobile)
...
public class InputManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                // Coba dapatkan komponen RumorCardClickHandler
                RumorCardClickHandler cardClickHandler = hit.collider.GetComponent<RumorCardClickHandler>();
