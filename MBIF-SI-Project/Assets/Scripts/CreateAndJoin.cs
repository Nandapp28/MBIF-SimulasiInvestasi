...
public class CreateAndJoin : MonoBehaviourPunCallbacks
{
    ...
    public TMP_InputField popupUsernameInput; // Username untuk create room
    public TMP_InputField popupRoomNameInput;
    public TMP_InputField joinUsernameInput;  // Username untuk join room
    ...
    public void CreateRoomFromPopup()
    {
        ...
        string username = popupUsernameInput.text;
